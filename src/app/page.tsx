      ...
      <div className="bg-[#161618] text-white">
        <header className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16 sm:h-20">
              <div className="flex items-center gap-2">
                <DFansLogo />
                <span className="font-bold text-xl">Winkermind</span>
              </div>
              <nav className="hidden md:flex items-center gap-8 text-sm">
                <Link href="#" className="hover:text-gray-300">Creadores</Link>
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center md:text-left">
              ...
              <p className="text-sm text-gray-400 mb-6">Más de +1,000 Creadores disponibles</p>
              <h1 className="text-5xl font-bold mb-4">Encuenta cientos<br/>de creadores</h1>
              <p className="text-gray-400 mb-8 max-w-md mx-auto md:mx-0">Sin censura, alta privacidad y acceso gratuito</p>
              <div className="flex flex-col sm:flex-row justify-center md:justify-start items-center gap-4">
                <Button className="bg-gradient-to-r from-yellow-400 to-pink-500 text-black font-bold rounded-full px-8 py-6 text-lg hover:from-[#FF2541] hover:to-[#FF9A02] hover:text-white">Explorar Creadores</Button>
                <Link href="#" className="text-white font-semibold text-lg">Registrate</Link>
              </div>
              <p className="text-xs text-gray-500 mt-2"> <br/> *Registrate sin costo para poder ver más contenido exclusivo*</p>
            </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
            {creators.map((creator) => (
              <Link href={`/creators/${creator.slug}`} key={creator.name}>
                <Card className="overflow-hidden cursor-pointer group border-none shadow-lg">
